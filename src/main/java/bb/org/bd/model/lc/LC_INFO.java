...
@JsonPropertyOrder({"LC_ID", "LC_DATE", "LC_EXPIRY_DATE", "LAST_SHIPMENT_DATE", "UPDATE_STATUS", "UPDATE_DATE", "LC_AMOUNT", "CURRENCY", "COUNTRY_CODE_IMP", "BIN", "IMPORTERNAME", "BENEFICIARY"})
//@XmlType (propOrder={"LC_ID", "LC_DATE", "LC_EXPIRY_DATE", "LAST_SHIPMENT_DATE", "UPDATE_STATUS", "UPDATE_DATE", "LC_AMOUNT", "CURRENCY", "COUNTRY_CODE_IMP", "BIN", "IMPORTERNAME", "BENEFICIARY"})
